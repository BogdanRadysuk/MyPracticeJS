...
//     modules.innerText = `${item.modules}`
//     mainDiv.append(modules)
//
//     let ul = document.createElement('ul')
//     mainDiv.append(ul)
//
//     for (let i = 0; i < coursesArray.length; i++) {
//         let mainSkills = document.createElement('div')
//         mainSkills.innerText = `${item.modules}`
//     }
...
// (Додатковачастина для завдання)- є масив
// let simpsons = [
//     {
//         name: 'Bart',
//         surname: 'Simpson',
...
//
// button.onclick = function () {
//     let qwe = input1.value
//     let asd = input2.value
//     let value = input3.value
//
//     let generatePlate = function (raws, colums, word){
//         let table = document.createElement('table')
//         table.style.border = `3px solid purple`
//         document.body.append(table)
//         for (let i = 0; i < raws; i++) {
//          let raw = document.createElement('qwe')
//             table.append(raw)
//             for (let j = 0; j < colums; j++) {
//              let column = document.createElement('asd')
//                 column.innerText = `${word}`
//                 column.style.border = `3px solid yellow`
//                 raw.append(column)
//             }
//         }
//     }
//     generatePlate(qwe, asd, value)
}
